...
model_path = '/content/drive/MyDrive/model (1).h5'
...
model_yolo = YOLO('/content/drive/MyDrive/boundingbox/types/best.pt')
...
image_path = "/content/Screenshot (228).png"  # Provide the path to your image
